...
SOURCEFILES_QUOTED_IF_SPACED=main.c "C:/Archivos de programa/Unimic/unmc_01/sources/unmc_lcd_216.c" keyboard.c "../../Program Files/Unimic/unmc_01/sources/unmc_rtcc_01.c" reloj.c lcd_vision.c config.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/_ext/1807342946/unmc_lcd_216.p1 ${OBJECTDIR}/keyboard.p1 ${OBJECTDIR}/_ext/968420362/unmc_rtcc_01.p1 ${OBJECTDIR}/reloj.p1 ${OBJECTDIR}/lcd_vision.p1 ${OBJECTDIR}/config.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/_ext/1807342946/unmc_lcd_216.p1.d ${OBJECTDIR}/keyboard.p1.d ${OBJECTDIR}/_ext/968420362/unmc_rtcc_01.p1.d ${OBJECTDIR}/reloj.p1.d ${OBJECTDIR}/lcd_vision.p1.d ${OBJECTDIR}/config.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/_ext/1807342946/unmc_lcd_216.p1 ${OBJECTDIR}/keyboard.p1 ${OBJECTDIR}/_ext/968420362/unmc_rtcc_01.p1 ${OBJECTDIR}/reloj.p1 ${OBJECTDIR}/lcd_vision.p1 ${OBJECTDIR}/config.p1

# Source Files
SOURCEFILES=main.c C:/Archivos de programa/Unimic/unmc_01/sources/unmc_lcd_216.c keyboard.c ../../Program Files/Unimic/unmc_01/sources/unmc_rtcc_01.c reloj.c lcd_vision.c config.c
...
${OBJECTDIR}/reloj.p1: reloj.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"C:/Archivos de programa/Unimic/unmc_01/headers" -I"C:/Archivos de programa/Microchip/xc8/v1.32/include/plib" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/reloj.p1  reloj.c 
	@-${MV} ${OBJECTDIR}/reloj.d ${OBJECTDIR}/reloj.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/reloj.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/lcd_vision.p1: lcd_vision.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lcd_vision.p1.d 
	@${RM} ${OBJECTDIR}/lcd_vision.p1 
